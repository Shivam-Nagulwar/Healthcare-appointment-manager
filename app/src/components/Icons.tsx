...
// Each icon is a 20x20 SVG matching the sidebar-link-icon size
...
const Icon = ({ children, size = 20, className, style }: IconProps & { children: React.ReactNode }) => (
  <svg
...
export const StarFilledIcon = ({ size = 20, className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth={1} className={className} style={style}>
...
export const SparklesIcon = ({ size = 20, className, style }: IconProps) => (
...
export const PillIcon = ({ size = 20, className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const StethoscopeIcon = ({ size = 20, className, style }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
