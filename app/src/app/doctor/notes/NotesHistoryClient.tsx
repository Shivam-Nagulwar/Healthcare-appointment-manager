...
export default function NotesHistoryClient({ doctorAppointments }: { doctorAppointments: any[] }) {
                  ...
                  {hasNotes ? (
                    <>
                      ...
                      <div className={styles.noteTags}>
                        ...
                        {apt.postVisitNote!.prescriptions.length > 0 && (
                          <span className="badge badge-neutral">
                            💊 {apt.postVisitNote!.prescriptions.length} Rx
                          </span>
                        )}
